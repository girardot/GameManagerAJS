...
INSERT INTO GAME(ID, DEMATERIALIZED, TITLE, PROGRESSION, CONSOLE_ID) VALUES (nextval('hibernate_sequence'), false, 'warhammer 40000: fire warrior', (SELECT ID FROM CONSOLE WHERE CONSOLE_NAME='PS2'));
